...
function Home() {
  ...
  const handleClick =()=>{
    window.open('https://www.youtube.com/@javascriptmastery','_blank')
      ...
      <div className="container">
        <div className="home-container">
          <div className="home-content">
            ...
            <p> Master Trending Technologies with TechMaster, Invest your time and return skills.</p>
        ...
        <div className="home-img">
          <div className="home-img-wrapper">
            ...
            <div className="whatsapp-container" key="whatsapp-container">
          <h5>500 + students</h5>
          <AiOutlineWhatsApp color="green" />
        </div>
        <div className="support" key="support">
